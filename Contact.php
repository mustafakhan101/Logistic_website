        ...
        <div class="row py-2 px-lg-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a class="text-white px-2" href="https://pk.linkedin.com/">
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            <a href="index.html" class="navbar-brand ml-lg-3">
                <h1 class="m-0 display-5 text-uppercase text-primary"><i class="fa fa-truck mr-2"></i>CMS</h1>
            </a>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        ...
                        <form action="" method="post" >
                            ...
                            <div>
                                <button class="btn btn-primary py-3 px-4" name="Btn_Contact" type="submit" id="sendMessageButton">Send
                                    Message</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <div class="d-flex justify-content-start mt-4">
                            <a class="btn btn-outline-light btn-social mr-2" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-social mr-2" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-social mr-2" href="https://pk.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: #3E3E4E !important;">
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a href="Index.php">Courier Mangement System</a>
				
				<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
				Designed by Students of Miss Samreen
                </p>
            </div>
...
if (isset($_POST["Btn_Contact"])) {
    ...
    $Insert_query = "INSERT INTO `tbl_contact`(`name`, `email`, `subject`, `message`)
